...
# LESS and CSS
LESS 		 	= theme_style.less style_ts.less base.less base2.less light.less color.less dark.less colorful.less typography.less fun.less #style1.less #style2.less
...
# target: upgrade-normalize       - Upgrade LESS module - Normalize. Inlagt 15/11-16.
...
# target: upgrade-grid - Upgrade LESS module - Grid float & Grid flex. 	Inlagt 2/12-16.
.PHONY: upgrade-grid
upgrade-grid:
	@$(call HELPTEXT,$@)

	# Grid-float & Grid-flex
